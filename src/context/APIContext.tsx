...
export const APIEndPointsContext =
  createContext<APIEndPointsContextInterface>(defaultState)

type APIEndPointsProviderProps = {
  children: React.ReactNode
}

export default function APIEndPointsProvider({
  children,
}: APIEndPointsProviderProps) {
